<div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-flex align-items-center justify-content-between my-4 page-header-breadcrumb flex-wrap gap-2">
                    <div>
                        <p class="fw-medium fs-20 mb-0">Welcome To .........</p>
                        <p class="fs-13 text-muted mb-0">Lucky lucky</p>
                    </div>
                    <div class="btn-list">
                                ...
                                <div class="card custom-card overflow-hidden">
                                    <div class="card-body p-0">
                                        <div class="mb-2 p-3 pb-0">
                                            <div class="flex-fill fs-15">Total products</div>
                                        </div>
                                        <div class="d-flex align-items-center ps-3">
                                            <div class="flex-fill">
                                                <div class="fs-25 fw-normal mb-2"><?php $count = countpr(); echo $count[0]['COUNT(sanpham.id)']; ?></div>
                                                <p class="mb-0">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center"> 
                                            <div class="flex-fill">
                                                ...
                                                <div class="progress progress-animate progress-xs" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center"> 
                                            <div class="flex-fill">
                                                ...
                                                <div class="progress progress-animate progress-xs" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center"> 
                                            <div class="flex-fill">
                                                ...
                                                <div class="progress progress-animate progress-xs" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">
                    ...
                    <div class="col-md-12 col-xl-12 col-xxl-8">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-header justify-content-between">
                                ...
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="btn btn-primary-light" data-bs-toggle="dropdown" aria-expanded="false">
                                        Sort By <i class="ri-arrow-down-s-line align-middle ms-1 d-inline-block"></i>
                                    </a>
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a class="dropdown-item" href="javascript:void(0);">This Week</a></li>
                                    ...
                                    <table class="table text-nowrap table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>$569</td>
                                                <td>
                                                    <span class="badge bg-success-transparent ps-3 fs-11 order-status complete">
                                                        Completed
                                                    </span>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a aria-label="anchor" href="javascript:void(0);" class="btn btn-icon btn-sm btn-primary-light btn-wave me-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit"><i class="ri-pencil-line"></i></a>
                                                        <a aria-label="anchor" href="javascript:void(0);" class="btn btn-icon btn-sm btn-secondary-light btn-wave" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Download"><i class="ri-download-line"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>$108</td>
                                                <td>
                                                    <span class="badge bg-danger-transparent ps-3 fs-11 order-status cancel">
                                                        Cancelled
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>$786</td>
                                                <td>
                                                    <span class="badge bg-warning-transparent ps-3 fs-11 order-status pending">
                                                        Pending
                                                    </span>
                                                </td>
                                                <td>
                    ...
                    <div class="col-md-12 col-xl-12 col-xxl-4">
                        <div class="card custom-card overflow-hidden">
                            ...
                            <div class="card-footer">
                                <div class="text-center">
                                    <a href="javascript:void(0);">
                                        <span class="text-secondary">View All <i class="ri-share-box-line align-middle"></i></span>
                                    </a>
                                </div>
                            </div>
                        </div>
