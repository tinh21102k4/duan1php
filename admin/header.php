...
<!-- Mirrored from spruko.com/demo/udon/dist/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Dec 2023 15:54:05 GMT -->
<head>
        ...
        <ul class="header-content-right">
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-start cart-dropdown-item">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-start justify-content-between mb-0">
                                        <div class="mb-0 fs-13 text-dark">
                                            <a href="cart.html">Multi Color Dress for Girls (3Y - 4Y)</a>
                                        </div>
                                        <div>
                    ...
                    <div class="p-3 empty-header-item border-top">
                        <div class="text-center">
                            <a href="checkout.html" class="link-primary text-decoration-underline">Proceed to checkout</a>
                        </div>
                    </div>
            ...
            <li class="header-element">
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="http://localhost/dan1/"><i class="bi bi-box-arrow-right fs-18 me-2 op-7"></i>Thoat</a></li>
                </ul>
            </li>  
            <!-- End::header-element -->
            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1 pages-ul">
                        ...
                        <li class="slide">
                            <a href="index.php?act=adddm" class="side-menu__item">Thêm danh mục</a>
                        </li>
                        <li class="slide">
                            <a href="index.php?act=listdm" class="side-menu__item">List danh mục</a>
                        </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="index.php?act=listsp" class="side-menu__item">Danh Sách sản phẩm</a>
                        </li> 
                        <li class="slide">
                            <a href="index.php?act=addsp" class="side-menu__item">Them san pham</a>
                        </li>
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Tai khoan</span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                            <a href="javascript:void(0)">Tai khoan</a>
                        </li>
                        <li class="slide">
                            <a href="index.php?act=listtk" class="side-menu__item">danh sach tai khoan</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">binh luan</span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                            <a href="javascript:void(0)">binh luan</a>
                        </li>
                        <li class="slide">
                            <a href="index.php?act=listbl" class="side-menu__item">danh sach binh luan</a>
                        </li>
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Thong ke </span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                            <a href="javascript:void(0)">Thong ke </a>
                        </li>
                        <li class="slide">
                            <a href="index.php?act=thongke" class="side-menu__item">danh sach thong ke</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">quan ly gio hang</span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1 mega-menu">
                        <li class="slide side-menu__label1">
                            <a href="javascript:void(0)">quan ly gio hang</a>
                        </li>
                        <li class="slide">
                            <a href="index.php?act=listgh" class="side-menu__item">danh sach gio hang</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
